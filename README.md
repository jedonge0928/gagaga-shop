...
**"가가가 - 가구 쇼핑몰"**은 HTML, CSS, JavaScript를 활용해 제작한 **정적인 가구 브랜드 웹사이트**입니다.  
Flex를 이용한 적응형 레이아웃, Swiper.js를 활용한 슬라이더 등 UI 중심의 기능과  
**로그인/회원가입, 리뷰 작성, 페이지네이션** 등 다양한 **사용자 중심 기능**들을 직접 구현했습니다.

---

##  제작 목적

- HTML, CSS, JavaScript만으로 웹사이트 전체를 처음부터 완성해보는 것이 목적
- 로그인, 회원가입, 리뷰 작성 등 **실사용 기능**들을 직접 구현하여 경험 축적
- 외부 API 및 로컬 저장소(localStorage)를 통한 상태 관리 연습
- 데이터는 직접 작성한 `data.json` 및 `localStorage`로 처리
...
<img width="529" height="323" alt="image" src="https://github.com/user-attachments/assets/70b61a97-f42e-4e76-8cb5-f57bb54dce12" />
<img width="559" height="428" alt="image" src="https://github.com/user-attachments/assets/b9578e7c-143e-4639-945b-39447dd1fca2" />
<img width="467" height="415" alt="image" src="https://github.com/user-attachments/assets/263b1f3f-5fcd-4dac-80c7-03be3991d663" />
<img width="558" height="582" alt="image" src="https://github.com/user-attachments/assets/f70062c0-c0f0-435e-b1c2-e5b86a032946" />
<img width="500" height="236" alt="image" src="https://github.com/user-attachments/assets/72585980-4bdf-4dd8-8264-1e3a420bac2e" />
...
### 상세 페이지
-제품 이미지 선택
<img width="495" height="417" alt="image" src="https://github.com/user-attachments/assets/8dbe8570-87a6-4e68-afba-a970a54398c1" />
- 리뷰 작성 기능 (localStorage 저장)
  1. 리뷰구조<img width="577" height="511" alt="image" src="https://github.com/user-attachments/assets/74354a72-2a48-4299-9bb0-9abd7893af24" />
...
-  <img width="439" height="433" alt="image" src="https://github.com/user-attachments/assets/8e5f9b9e-bd84-4dd1-9eed-48aa3060bd04" />
...
- 프로필 이미지 업로드
- <img width="395" height="210" alt="image" src="https://github.com/user-attachments/assets/39654b14-cee5-4b16-9efe-9bd1e7f30698" />

- 다음 주소 검색 API 연동
- <img width="570" height="389" alt="image" src="https://github.com/user-attachments/assets/51383868-68e7-413e-9f16-69ad9911d6b2" />

- (회원가입form)입력 정보는 localStorage에 저장 및 유지
<img width="574" height="231" alt="image" src="https://github.com/user-attachments/assets/e523e51b-f8d7-4f2a-ac99-ba65e48000f5" />
...
- HTML/CSS/JS/images 등의 정적 파일을 직접 업로드하여  
  **브라우저에서 사용자 접근 가능**
